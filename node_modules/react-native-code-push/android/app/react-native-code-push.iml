...
<module external.linked.project.id=":react-native-code-push" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../Examples/CodePushDemoApp/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
